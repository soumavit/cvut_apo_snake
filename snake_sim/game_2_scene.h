 ...
 * game_2_scene.h
 * 
 * Scene obtaing the actual snake game mode for 2 players
 * 
 * created by Vit Soumar and Marek Jirku for computer architectures course semestral project
*/


#ifndef __GAME_2_SCENE_H__
#define __GAME_2_SCENE_H__
...
#define MEM_ALLOC_ERROR_GAME2 104

extern int GAME2_WIDTH;
extern int GAME2_HEIGHT;
